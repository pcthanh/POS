   ...
   public class AccountPaymentService:IAccountPaymentService
    {
        ...
        {
            var list = _context.ACC_PAYMENT.Where(x => x.CusNo == CusNo && x.CreateDate.Value.Year >= TimeFrom.Year && x.CreateDate.Value.Month >= TimeFrom.Month && x.CreateDate.Value.Day >= TimeFrom.Day && x.CreateDate.Value.Year <= TimeTo.Year && x.CreateDate.Value.Month <= TimeTo.Month && x.CreateDate.Value.Day <= TimeTo.Day)
