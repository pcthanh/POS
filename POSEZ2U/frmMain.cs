...
namespace POSEZ2U
{
    public partial class frmMain : Form
    {
        ...
        {
            ProgramType.isStore = Convert.ToBoolean(ConfigurationManager.AppSettings.Get("isStore"));
        }
        private void setImageButton()
        {
            try
            {
                if (ProgramType.isStore)
                {
                    Image eatin_disable = Properties.Resources.eatin_disable;
                    Image tka_eatin_disable = Properties.Resources.tka_disable;
                    Image store_Enabled = Properties.Resources.store_enable;
                    btnEatIn.Image = eatin_disable;
                    btnTakeAway.Image = tka_eatin_disable;
                    btnStore.Image = store_Enabled;
                }
                else
                {
                    Image eatin_enable = Properties.Resources.eatin_enable;
                    Image tka_eatin_enable = Properties.Resources.tka_enable;
                    Image store_disable = Properties.Resources.store_disable;
                    btnEatIn.Image = eatin_enable;
                    btnTakeAway.Image = tka_eatin_enable;
                    btnStore.Image = store_disable;
                }
            }
            catch (Exception ex)
            {
                LogPOS.WriteLog("frmMain:::::::::::::::::::::::::setImage():::::::::::::::::" + ex.Message);
            }
        }
    }
}
