...
namespace POSEZ2U
{
    public partial class frmOrder : Form
    {
        ...
        private void ButtonIsStore()
        {
            if (ProgramType.isStore)
            {
                this.ucSendOrder.Visible = false;
                this.ucPePrint.Visible = false;
                this.ucAddseat.Visible = false;
            }
        }
            ...
            try
            {
                ...
                if (frmOpacity.ShowDialog(this, frm) == System.Windows.Forms.DialogResult.OK)
                {
                    ...
                    if (resul == 1)
                    {
                        ...
                        OrderMain.addModifierToList(modifierTemp, keyItemTemp,OrderMain.IsLoadFromData);
        ...
        void ucModifierOfMenu_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                OrderMain.addModifierToList(modifier, keyItemTemp,OrderMain.IsLoadFromData);
                UCItemModifierOfMenu ucItemModifierOfMenu = new UCItemModifierOfMenu();
        ...
        private void btnVoid_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        if (OrderMain.ListOrderDetail[i].ChangeStatus == 0 || OrderMain.ListOrderDetail[i].ChangeStatus ==1)
                            countChangeStatus++;
                        ...
                        if (items != null)
                        {
                            for (int i = 0; i < OrderMain.ListOrderDetail.Count; i++)
                            {
                                if (items.KeyItem == OrderMain.ListOrderDetail[i].KeyItem)
                                {
                                    ...
                                    if (OrderMain.IsLoadFromData && OrderMain.ListOrderDetail[i].ChangeStatus!=0)
                                        OrderMain.ListOrderDetail.RemoveAt(i);
                                    else
        ...
        public void LoadOrder(string TableID, int orderID)
        {
            ...
            try
            {
                ...
                OrderMain.UserName = POSEZ2U.Class.UserLoginModel.UserLoginInfo.UserName;
                
                OrderMain = OrderService.GetOrderByTable(TableID, 0);
                if (ProgramType.isStore)
                    OrderMain.isStore = ProgramType.isStore;
        ...
        private void ResetOrder()
        {
            ...
            {
                LogPOS.WriteLog("ResetOrder()::::::::::::::::::::::::" + ex.Message);
            }
        }
                        ...
                        if (OrderMain.ListOrderDetail.Count > 0)
                        {
                            ...
                            if (frmOpacity.ShowDialog(this, frm) == System.Windows.Forms.DialogResult.OK)
                            {
                                ...
                                else
                                {
                                    ...
                                    //moi update 13.07
                                    OrderDateModel orderTemp = OrderService.GetOrderByTable(OrderMain.FloorID, 0);
                                    //if (orderTemp.ListOrderDetail.Count == 0)
                                    //{
                                    //    SendOrder();
                                    //    InvoiceService.UpdateOrderInvice(OrderMain);
                                    //}/////moi update 13.07
        ...
        private void ucOpenTill1_Click(object sender, EventArgs e)
        {
            ...
            foreach (PrinterModel item in PrintData)
            {
                if (item.PrinterType == 4)
                {
                    ...
                    SystemLog.LogPOS.WriteLog("frmOrder::::::::::::::::ucOpenTill1_Click:::::::::::::::::" + item.PrinterName);
                }
            }
        }
    }
